...
from directories import word2vec_models, word2vec_scores
models_dir =    word2vec_models()
score_dir =     word2vec_scores()
...
from SentenceIterators import UnlabeledSentences
...
class Word2VecModel (object): 
    ...
    def train_model (self): 
        ...
        for epoch in range(20):
            ...
            self.model.train(UnlabeledSentences())
